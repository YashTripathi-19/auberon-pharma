...
Error: strict mode violation: locator('text=Auberon Pharmaceuticals') resolved to 6 elements:
    1) <span class="font-display text-[1.05rem] md:text-[1.15rem] font-bold leading-tight tracking-wide transition-colors duration-300 text-white">Auberon Pharmaceuticals</span> aka getByRole('link', { name: 'Auberon Pharmaceuticals' })
    ...
    5) <p>Auberon Pharmaceuticals</p> aka getByRole('contentinfo').getByText('Auberon Pharmaceuticals', { exact: true })
...
- generic [active] [ref=e1]:
  ...
  - main [ref=e22]:
    ...
    - generic [ref=e359]:
      - paragraph [ref=e360]: Work With Us
      - heading "Become a partner." [level=2] [ref=e361]
      - paragraph [ref=e362]: We supply directly to wholesalers, hospitals, and ophthalmology clinics. If you're looking to stock quality ophthalmic products, let's talk.
      - generic [ref=e363]:
        - generic [ref=e364]:
          - paragraph [ref=e365]: Wholesalers & Distributors
          - heading "Partner with us for bulk supply." [level=3] [ref=e366]
          - paragraph [ref=e367]: Competitive margins, reliable stock, and direct manufacturer pricing on our full ophthalmic range.
          - generic [ref=e368]:
            - link "Sign Up as Wholesaler" [ref=e369] [cursor=pointer]:
              - /url: /signup/wholesale
            - link "Enquire first" [ref=e370] [cursor=pointer]:
              - /url: /support
              - text: Enquire first
              - img [ref=e371]
        - generic [ref=e373]:
          - paragraph [ref=e374]: Doctors & Clinics
          - heading "Stock directly at your clinic." [level=3] [ref=e375]
          - paragraph [ref=e376]: We handle delivery, documentation, and after-sales support so you can focus on your patients.
          - generic [ref=e377]:
            - link "Sign Up as Clinic" [ref=e378] [cursor=pointer]:
              - /url: /signup/clinic
            - link "Enquire first" [ref=e379] [cursor=pointer]:
              - /url: /support
              - text: Enquire first
              - img [ref=e380]
    - generic [ref=e383]:
      - generic [ref=e384]:
        - paragraph [ref=e385]: Eye Health Tools
        - heading "Check your vision health." [level=2] [ref=e386]
        - paragraph [ref=e387]: Try our free preliminary eye health screening tools — developed to help you understand your vision better.
      - generic [ref=e388]:
        - generic [ref=e389]:
          - img [ref=e391]
          - generic [ref=e394]:
            - heading "Colour Blindness Test" [level=3] [ref=e395]
            - paragraph [ref=e396]: Take our Ishihara-style screening test to check for colour vision deficiencies. Takes under 2 minutes.
          - link "Take the Test" [ref=e397] [cursor=pointer]:
            - /url: /eye-tests/colour-blindness
        - generic [ref=e398]:
          - img [ref=e400]
          - generic [ref=e403]:
            - heading "Live Eye Scan" [level=3] [ref=e404]
            - paragraph [ref=e405]: Use your device camera for a preliminary AI-powered screening for conjunctivitis and cataract. Results in under 30 seconds.
          - link "Start Eye Scan" [ref=e406] [cursor=pointer]:
            - /url: /eye-tests/scan
        - generic [ref=e407]:
          - img [ref=e409]
          - generic [ref=e412]:
            - heading "Eye Knowledge Hub" [level=3] [ref=e413]
            - paragraph [ref=e414]: Explore interactive guides on myopia, hyperopia, conjunctivitis, cataract and vision correction options with a 3D eye model.
          - link "Explore Hub" [ref=e415] [cursor=pointer]:
            - /url: /eye-knowledge
    - generic [ref=e417]:
      - paragraph [ref=e418]: Stay Updated
      - heading "Join our community." [level=2] [ref=e419]
      - paragraph [ref=e420]: Get product updates, eye health tips, and exclusive offers delivered to your inbox.
      - generic [ref=e423]:
  ...
  - contentinfo [ref=e426]:
    - generic [ref=e427]:
      - generic [ref=e428]:
        - generic [ref=e429]:
          - paragraph [ref=e430]: Auberon Pharmaceuticals
          - paragraph [ref=e431]: Chandra Pharma
          - paragraph [ref=e432]: Specialised ophthalmic formulations manufactured by Chandra Pharma. Trusted by ophthalmologists, wholesalers, and patients across India since 2010.
        - generic [ref=e433]:
          - paragraph [ref=e434]: Navigate
          - generic [ref=e435]:
            - link "Home" [ref=e436] [cursor=pointer]:
              - /url: /
            - link "Products" [ref=e437] [cursor=pointer]:
              - /url: /products
            - link "Order Medicine" [ref=e438] [cursor=pointer]:
              - /url: /shop
            - link "Support & FAQ" [ref=e439] [cursor=pointer]:
              - /url: /support
            - link "Admin Portal" [ref=e440] [cursor=pointer]:
              - /url: /admin/login
        - generic [ref=e441]:
          - paragraph [ref=e442]: Contact
          - generic [ref=e443]:
            - generic [ref=e444]:
              - img [ref=e445]
              - generic [ref=e448]: Kanpur, Uttar Pradesh, India
            - generic [ref=e449]:
              - img [ref=e450]
              - link "+91 6307922085" [ref=e452] [cursor=pointer]:
                - /url: tel:+916307922085
            - generic [ref=e453]:
              - img [ref=e454]
              - link "auberon.pharma@gmail.com" [ref=e457] [cursor=pointer]:
                - /url: mailto:auberon.pharma@gmail.com
      - generic [ref=e458]:
        - paragraph [ref=e459]: © 2026 Auberon Pharmaceuticals. All rights reserved.
        - generic [ref=e460]:
  ...
  - generic [ref=e463]:
    ...
    - button "Open support chat" [ref=e464] [cursor=pointer]:
      - img [ref=e465]
