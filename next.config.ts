...
const nextConfig: NextConfig = {
  // Prevent Next.js from bundling pdfkit — it must run as a native Node module
  // so it can resolve its font .afm files from node_modules at runtime
        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              ...
              "connect-src 'self' https://api.anthropic.com https://lottie.host",
